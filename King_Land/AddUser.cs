...

        {
            ...
            else
            {
                try
                {
                    ...
                    string query = "INSERT INTO kingland.user (name, email, password, department, position, contact, status) VALUES ('" + name + "', '" + tb_email.Text + "', '" + tb_password.Text + "', '" + cb_department.SelectedItem.ToString() + "', '" + cb_position.SelectedItem.ToString() + "', '" + tb_contact.Text +"', '" + "Inactive"+"')";
